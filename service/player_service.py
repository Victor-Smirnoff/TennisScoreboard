...
class PlayerService:
    ...
    Данный класс работает только в случае ввода корректных данных в поля “Имя игрока 1” и “Имя игрока 2”
    То есть до вызова этого класса сначала требуется выполнить проверку
    ...
    def get_two_players(self):
        """
        Метод для получения двух объектов класса PlayerOrm, который будут проводить матч
    ...
    def get_player(self, player_name):
        ...
        Если игрока такого нет, то он туда записывается и вытаскивается
